...
TutorialText::TutorialText() : GNum(0), GColor(GREEN), Gbutton_draw{ false, false, false }, GGNum(0), frame(0)
{
}
...
void TutorialText::GDrawPlayer(int xNum, int yNum, int add_y)const
{
	//頭
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 646 + yNum - in_camera.y - add_y, 23, 15, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, GREEN, true);
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 646 + yNum - in_camera.y - add_y, 23, 15, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, 0x000000, false);

	//目
	ResourceManager::DrawRotaBox(1824 - xNum - in_camera.x, stage_height - 646 + yNum - in_camera.y - add_y, 6, 7, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, 0x000000, true);

	//首
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 660 + yNum - in_camera.y - add_y, 10, 5, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, GREEN, true);
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 660 + yNum - in_camera.y - add_y, 10, 5, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, 0x000000, false);

	//胴体																					
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 686 + yNum - in_camera.y - add_y, 21, 37, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, GREEN, true);
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 686 + yNum - in_camera.y - add_y, 21, 37, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, 0x000000, false);

	//バッグ
	ResourceManager::DrawRotaBox(1845 - xNum - in_camera.x, stage_height - 686 + yNum - in_camera.y - add_y, 5, 23, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, GREEN, true);
	ResourceManager::DrawRotaBox(1845 - xNum - in_camera.x, stage_height - 686 + yNum - in_camera.y - add_y, 5, 23, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, 0x000000, false);
	ResourceManager::DrawRotaBox(1845 - xNum - in_camera.x, stage_height - 686 + yNum - in_camera.y - add_y, 3, 15, 1830 - in_camera.x, stage_height - 646 - in_camera.y, 0, 0x000000, true);

	//腕
	ResourceManager::DrawRotaBox(1815 - xNum - in_camera.x, stage_height - 616 + yNum - in_camera.y - add_y, 28, 7, 1830 - in_camera.x, stage_height - 616 - in_camera.y, 0, GREEN, true);
	ResourceManager::DrawRotaBox(1815 - xNum - in_camera.x, stage_height - 616 + yNum - in_camera.y - add_y, 28, 7, 1830 - in_camera.x, stage_height - 616 - in_camera.y, 0, 0x000000, false);

	//足												 														
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 651 + yNum - in_camera.y - add_y, 7, 27, 1830 - in_camera.x, stage_height - 616 - in_camera.y, 0, GREEN, true);
	ResourceManager::DrawRotaBox(1830 - xNum - in_camera.x, stage_height - 651 + yNum - in_camera.y - add_y, 7, 27, 1830 - in_camera.x, stage_height - 616 - in_camera.y, 0, 0x000000, false);

	//帽子　中央
	DrawTriangleAA(1830 + xNum - in_camera.x, stage_height - 667 - yNum - in_camera.y + add_y, 1820 + xNum - in_camera.x, stage_height - 651 - yNum - in_camera.y + add_y, 1840 + xNum - in_camera.x, stage_height - 651 - yNum - in_camera.y + add_y, GREEN, true);
	DrawTriangleAA(1830 + xNum - in_camera.x, stage_height - 667 - yNum - in_camera.y + add_y, 1820 + xNum - in_camera.x, stage_height - 651 - yNum - in_camera.y + add_y, 1840 + xNum - in_camera.x, stage_height - 651 - yNum - in_camera.y + add_y, 0x000000, false);
	//帽子　右側
	DrawTriangleAA(1830 + xNum - in_camera.x, stage_height - 667 - yNum - in_camera.y + add_y, 1840 + xNum - in_camera.x, stage_height - 651 - yNum - in_camera.y + add_y, 1850 + xNum - in_camera.x, stage_height - 655 - yNum - in_camera.y + add_y, GREEN, true);
	DrawTriangleAA(1830 + xNum - in_camera.x, stage_height - 667 - yNum - in_camera.y + add_y, 1840 + xNum - in_camera.x, stage_height - 651 - yNum - in_camera.y + add_y, 1850 + xNum - in_camera.x, stage_height - 655 - yNum - in_camera.y + add_y, 0x000000, false);
	//帽子　左側
