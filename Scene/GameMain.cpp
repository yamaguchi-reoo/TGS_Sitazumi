...
AbstractScene* GameMain::Update()
{
	...
	UpdateCamera();
	//サイズの更新
	ResourceManager::SetEreaRate(erea_rate);
...
void GameMain::PlayerUpdate()
{
	...
	{
		object[player_object]->SetScreenPosition(camera_location, impact_rand, erea_rate);
